...
(function ($) {
    ...
    $.fn.modalDengkul = function (customOptions) {
        ...
        $('body').append('<div id="modalDengkul" style="display:none"><div class="modalDengkul-inner"><a class="modalDengkul-close" href="#">&times;</a><div class="modalDengkul-left"><div class="modalDengkul-left-inner"></div></div><div class="modalDengkul-right" style="height:'+(height_colleft-50)+'px !important"></div></div></div><div id="modalDengkul-overlay" style="display:none"></div>');
    ...
    var modalDengkul = {
        open: function ($this) {
            ...
            mright.html('<div class="modalDengkul-right-inner"><nguyen huu hai</div>');
